...
API_ID = int(os.environ.get("API_ID", "8754146")) #API ID from https://my.telegram.org/auth
API_HASH = os.environ.get("API_HASH", "8b56a6989f6d04f6f4fe78133ade02fd") #API Hash from https://my.telegram.org/auth
BOT_TOKEN = os.environ.get("BOT_TOKEN", "5652824975:AAFRr_eoGmmxLlyWhmpdsq5xkQFE1ot8EAI") # Bot token from @BotFather
...
#  Optionnal variables
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001743070157")) # log channel for information about users
UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "Sk_Network") # For Force Subscription
...
WELCOME_IMAGE = os.environ.get("WELCOME_IMAGE", 'https://www.linkpicture.com/q/IMG_20221209_092716_970.jpg') # image when someone hit /start
